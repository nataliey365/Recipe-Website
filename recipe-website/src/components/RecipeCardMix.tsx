...
export default function RecipeCardMix({recipeData}:Props){
    ...
    return (   
            ...
            <div className="border flex flex-col rounded-3xl h-170 w-130 flex bg-mandarin border-mandarin justify-center items-center">
                <div className={styles.maskmandarin}>
                    <div className="flex flex-col border-l-2 border-lightmand border-r-2 border-dashed justify-around mx-2 h-full py-12 px-3">
                <h1 className="font-playwrite text-center text-4xl/15 underline underline-offset-4 ">{recipeData.name}</h1>
            
                <div className="mt-4 font-manrope mx-auto px-3 text-xl border rounded-3xl" >Mixed</div>
